 ...
 * @author nguye
 */
public class MathClientGUI extends javax.swing.JFrame {

    /**
     * Creates new form MathClientGUI
     */
    MathService stub;
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jtfResult, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jtfNum1, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jtfNum2, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE))))))
    ...
    private void jbtnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnAddActionPerformed
        double a = Double.parseDouble(jtfNum1.getText());
        double b = Double.parseDouble(jtfNum2.getText());
        double result = 0;
        try {
            result = stub.add(a, b);
        } catch (RemoteException ex) {
            Logger.getLogger(MathClientGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jbtnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSubActionPerformed
        ...
        double result = 0;
        try {
            result = stub.subtrac(a, b);
        } catch (RemoteException ex) {
            Logger.getLogger(MathClientGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        jtfResult.setText(String.valueOf(result));    }//GEN-LAST:event_jbtnSubActionPerformed
    ...
    private void jbtnMultiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnMultiActionPerformed
        ...
        double result = 0;
        try {
            result = stub.multi(a, b);
        } catch (RemoteException ex) {
            Logger.getLogger(MathClientGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        jtfResult.setText(String.valueOf(result));    }//GEN-LAST:event_jbtnMultiActionPerformed
    ...
    private void jbtnDivActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDivActionPerformed
        ...
        jtfResult.setText(String.valueOf(result));    }//GEN-LAST:event_jbtnDivActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MathClientGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
